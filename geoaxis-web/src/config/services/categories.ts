    ...
    services: [
      {
        ...
        longDescription: [
          ...
          "Услугата е необходима преди започване на строителство или когато проектантът изисква надеждна геодезическа основа. Обикновено е достатъчен идентификатор или точен адрес на имота, както и налични документи, ако има такива.",
          "След обработка на измерванията се предоставят ситуация на съществуващото положение и цифрови файлове (DWG, PDF и др.), които могат директно да се използват за проектиране, съгласуване и последваща работа.",
        ],
        // "Геодезическото заснемане за проектиране предоставя точна и актуална информация за съществуващото положение на терена. То се използва преди изработване на инвестиционен проект, при подготовка за ново строителство или когато проектантът изисква надеждна геодезическа основа. За започване обикновено са нужни идентификатор или точен адрес на имота, документ за собственост при необходимост и налични стари скици или материали, ако има такива. След обработка на измерванията се предоставят ситуация на съществуващото положение и цифрови файлове, които могат да се използват за проектиране, съгласуване и последваща работа.",
      },
      // {
      //   slug: "za-proektirane",
      //   title: "Геодезическо заснемане за проектиране",
