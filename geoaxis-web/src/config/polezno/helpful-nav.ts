...
export const HELPFUL_NAV_ITEMS: readonly HelpfulNavItem[] = [
  {
    ...
    shortLabel: "Статии",
    href: "/polezno/statii",
    description: "Кратки обяснения за кадастър, ПУП, заснемане, трасиране и цени.",
    heroTitle: "Статии за геодезия",
    heroDescription:
      "Практични обяснения за казуси при покупка, строителство, проектиране и кадастър.",
    seo: {
      title: "Статии за геодезия и кадастър",
      description:
        "Практични статии за кадастър, ПУП, геодезическо заснемане, трасиране и цени. Ясни обяснения за собственици, строители и проектанти.",
    },
  },
  {
    slug: "rakovodstva",
